...
<section id="blogFull" class="blogFull singleOffset ofsBottom ">
	...
	<div class="container clearfix section" >
		<div class="sixteen columns"><h1 class="titleBig"><?php printf( __( 'Search Results for: %s', $textdoimain ), get_search_query() ); ?></h1></div>
	</div>
	<!--End container-->
	<!--Container-->
					...
					$j++; ?>						
						...
						<div class="blog_wrap">   
							<?php
								...
								'<p>'. _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'goddess' ).'</p>';
								get_search_form(); 
							?>
						 </div>	
                <?php endif;?> 					
